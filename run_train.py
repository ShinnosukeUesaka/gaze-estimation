...
if __name__ == '__main__':
	...
	config = get_train_config(config_yaml_path)
	...
	train_data_loader = get_data_loader(
		config.datasets.train.type, # for different loading pattern
		config.datasets.train.dir, 
		config.datasets.train.batch_size,
		is_load_label=True,
		num_workers = NUM_WORKERS,
		is_shuffle=True,
		keys_to_use=keys_to_use_train
	)
	
	validation_data_loader = get_data_loader(
		config.datasets.validation.type, # for different loading pattern
		config.datasets.validation.dir, 
		config.datasets.validation.batch_size,
		is_load_label=True,
		num_workers = NUM_WORKERS,
		is_shuffle=False,
		keys_to_use=keys_to_use_validation
	)
